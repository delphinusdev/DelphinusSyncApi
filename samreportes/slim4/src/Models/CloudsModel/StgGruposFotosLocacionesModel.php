...
class StgGruposFotosLocacionesModel extends BaseModel
{
    protected static string $tableName = 'stg_grupos_fotos_locaciones';
    ...
    /**
     * Representa la columna 'fecha_ingreso' en la base de datos.
     * @param string|null $alias Un alias opcional para la columna en la consulta.
     * @param string $tableAlias El alias de la tabla (ej. 'r').
     * @return \App\Utils\Column
     */
    public static function FechaIngreso(?string $alias = null, string $tableAlias = 'self'): Column
    {
        return new Column('fecha_ingreso', $alias, $tableAlias);
    }
}