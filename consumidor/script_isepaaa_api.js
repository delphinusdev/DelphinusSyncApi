...
(function () {
 ...
 // --- Inyección de HTML y CSS ---
    ...
    /**
     * CSS Minificado y con alcance local (#miModalReserva) para evitar conflictos.
     */


/*** 
    const modalCSS = ` #miModalReserva .modal-reserva-overlay{position:fixed;z-index:1000;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgba(0,0,0,.5);display:flex;align-items:center;justify-content:center;padding:10px;box-sizing:border-box}#miModalReserva .modal-reserva-contenido{background-color:#fefefe;padding:20px;border:1px solid #888;width:95%;max-width:650px;border-radius:8px;position:relative;max-height:95vh;overflow-y:auto;font-family:sans-serif;font-size:.95em;box-shadow:0 4px 12px rgba(0,0,0,.15)}#miModalReserva .modal-reserva-cerrar{color:#aaa;float:right;font-size:28px;font-weight:700;position:absolute;top:8px;right:15px;line-height:1}#miModalReserva .modal-reserva-cerrar:focus,#miModalReserva .modal-reserva-cerrar:hover{color:#000;text-decoration:none;cursor:pointer}#miModalReserva #modalReservaTitulo{margin-top:0;margin-bottom:15px;color:#333;font-size:1.3em}#miModalReserva .info-reserva-compacta{font-size:.85em;color:#555;background:#f8f8f8;padding:6px 10px;border-radius:4px;margin-top:-5px;margin-bottom:15px;display:flex;flex-wrap:wrap;justify-content:space-between;gap:8px 15px;border:1px solid #eee}#miModalReserva .info-reserva-compacta span{white-space:nowrap;position:relative}#miModalReserva .info-reserva-compacta span:not(:last-child)::after{content:'|';margin-left:15px;color:#ccc;font-weight:400}#miModalReserva h5{font-size:1.05em;color:#333;margin-top:20px;margin-bottom:8px;border-bottom:1px solid #eee;padding-bottom:4px}#miModalReserva .seccion-modal{margin-bottom:15px;padding-bottom:5px}#miModalReserva .seccion-modal:last-of-type:has(+ .mensaje-inferior){margin-bottom:5px}#miModalReserva #formPago,#miModalReserva #formReserva{display:flex;flex-direction:column;gap:12px}#miModalReserva .form-grid-compact{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px}#miModalReserva .form-group{display:flex;flex-direction:column}#miModalReserva label{margin-bottom:4px;font-weight:600;font-size:.88em;color:#444}#miModalReserva input[type=number],#miModalReserva input[type=text],#miModalReserva select{width:100%;padding:8px;height:auto!important;border:1px solid #ccc;border-radius:4px;box-sizing:border-box;background-color:#fff;font-size:.95em}#miModalReserva input:focus,#miModalReserva select:focus{border-color:#007bff;outline:none;box-shadow:0 0 0 2px rgba(0,123,255,.25)}#miModalReserva button[type=submit]{background-color:#007bff;color:#fff;padding:9px 15px;border:none;border-radius:4px;cursor:pointer;align-self:flex-end;margin-top:5px;font-size:.95em;transition:background-color .2s ease}#miModalReserva button[type=submit]:hover{background-color:#0056b3}#miModalReserva button[type=submit]:disabled{background-color:#6c757d;cursor:not-allowed}#miModalReserva .mensaje-inferior{font-size:.85em;margin-top:15px;padding:8px 12px;border-radius:4px;display:none;text-align:center}#miModalReserva .mensaje-inferior.complete{color:#fff;background-color:#454545;border:1px solid #c3e6cb;display:block}#miModalReserva .mensaje-inferior.success{color:#155724;background-color:#d4edda;border:1px solid #c3e6cb;display:block}#miModalReserva .mensaje-inferior.error{color:#721c24;background-color:#f8d7da;border:1px solid #f5c6cb;display:block}#miModalReserva .mensaje-alerta{margin-top:10px;padding:10px;background-color:#e9ecef;border:1px dashed #ccc;border-radius:4px;font-size:.9em;line-height:1.4;text-align:center}#miModalReserva .summary-box-compact{background-color:#f9f9f9;border:1px solid #ddd;border-radius:4px;padding:12px 15px;margin-top:15px}#miModalReserva .summary-box-compact h4{margin-top:0;margin-bottom:10px;font-size:1.1em;color:#333;border-bottom:1px solid #eee;padding-bottom:5px}#miModalReserva .detalle-impuesto-grid{display:grid;grid-template-columns:auto 1fr;gap:6px 15px;font-size:.9em;align-items:center}#miModalReserva .detalle-impuesto-grid strong{font-weight:600}#miModalReserva .detalle-impuesto-grid .text-right{text-align:right}#miModalReserva .detalle-impuesto-grid .grid-divider{grid-column:1/-1;border:0;border-top:1px dashed #eee;margin:8px 0}#miModalReserva .detalle-impuesto-grid .saldo-label{font-weight:700}#miModalReserva .detalle-impuesto-grid .saldo-mxn{font-size:.9em;color:#666;margin-left:5px}#miModalReserva .detalle-impuesto-grid .por-pagar-label{color:#c0392b}#miModalReserva .detalle-impuesto-grid .por-pagar-valor{color:#c0392b;font-weight:700}#miModalReserva .tabla-scroll-container{max-height:200px;overflow-y:auto;margin-top:10px;border:1px solid #ddd;border-radius:4px}#miModalReserva .tabla-pagos-reserva{width:100%;border-collapse:collapse;font-size:.85em;min-width:400px}#miModalReserva .tabla-pagos-reserva td,#miModalReserva .tabla-pagos-reserva th{border:1px solid #eee;padding:7px 10px;text-align:left}#miModalReserva .tabla-pagos-reserva th{background-color:#f5f5f5;font-weight:600;position:sticky;top:0;z-index:1}#miModalReserva .tabla-pagos-reserva tbody tr:nth-child(even){background-color:#fcfcfc}#miModalReserva .monto-group{width:50%;min-width:180px;max-width:250px}@keyframes pulse{0%{opacity:1}50%{opacity:.6}100%{opacity:1}}@keyframes spin{0%{transform:rotate(0)}100%{transform:rotate(360deg)}}#miModalReserva .preview-box{margin-top:10px;padding:10px;background-color:#e9ecef;border:1px dashed #ccc;border-radius:4px;font-size:0.9em;line-height:1.4;min-height:30px;font-weight:600;color:#4a4a4a;}#miModalReserva .mensaje-inferior.loading{color:#0056b3;background-color:#e6f2ff;border:1px solid #b3d9ff;display:flex;align-items:center;justify-content:center;padding-left:40px;min-height:40px;animation:pulse 1.5s infinite ease-in-out}#miModalReserva .mensaje-inferior.loading::before{content:'';position:absolute;left:15px;top:50%;transform:translateY(-50%);width:24px;height:24px;border:4px solid rgba(0,123,255,.3);border-top:4px solid #007bff;border-radius:50%;animation:spin .8s linear infinite}`;

*/

const modalCSS = ` #miModalReserva{position:fixed;z-index:1000;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgba(0,0,0,.5);display:flex;align-items:center;justify-content:center;padding:10px;box-sizing:border-box}#miModalReserva .modal-reserva-contenido{background-color:#fefefe;padding:20px;border:1px solid #888;width:95%;max-width:650px;border-radius:8px;position:relative;max-height:95vh;overflow-y:auto;font-family:sans-serif;font-size:.95em;box-shadow:0 4px 12px rgba(0,0,0,.15)}#miModalReserva .modal-reserva-cerrar{color:#aaa;float:right;font-size:28px;font-weight:700;position:absolute;top:8px;right:15px;line-height:1}#miModalReserva .modal-reserva-cerrar:focus,#miModalReserva .modal-reserva-cerrar:hover{color:#000;text-decoration:none;cursor:pointer}#miModalReserva #modalReservaTitulo{margin-top:0;margin-bottom:15px;color:#333;font-size:1.3em}#miModalReserva .info-reserva-compacta{font-size:.85em;color:#555;background:#f8f8f8;padding:6px 10px;border-radius:4px;margin-top:-5px;margin-bottom:15px;display:flex;flex-wrap:wrap;justify-content:space-between;gap:8px 15px;border:1px solid #eee}#miModalReserva .info-reserva-compacta span{white-space:nowrap;position:relative}#miModalReserva .info-reserva-compacta span:not(:last-child)::after{content:'|';margin-left:15px;color:#ccc;font-weight:400}#miModalReserva h5{font-size:1.05em;color:#333;margin-top:20px;margin-bottom:8px;border-bottom:1px solid #eee;padding-bottom:4px}#miModalReserva .seccion-modal{margin-bottom:15px;padding-bottom:5px}#miModalReserva .seccion-modal:last-of-type:has(+ .mensaje-inferior){margin-bottom:5px}#miModalReserva #formPago,#miModalReserva #formReserva{display:flex;flex-direction:column;gap:12px}#miModalReserva .form-grid-compact{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px}#miModalReserva .form-group{display:flex;flex-direction:column}#miModalReserva label{margin-bottom:4px;font-weight:600;font-size:.88em;color:#444}#miModalReserva input[type=number],#miModalReserva input[type=text],#miModalReserva select{width:100%;padding:8px;height:auto!important;border:1px solid #ccc;border-radius:4px;box-sizing:border-box;background-color:#fff;font-size:.95em}#miModalReserva input:focus,#miModalReserva select:focus{border-color:#007bff;outline:none;box-shadow:0 0 0 2px rgba(0,123,255,.25)}#miModalReserva button[type=submit]{background-color:#007bff;color:#fff;padding:9px 15px;border:none;border-radius:4px;cursor:pointer;align-self:flex-end;margin-top:5px;font-size:.95em;transition:background-color .2s ease}#miModalReserva button[type=submit]:hover{background-color:#0056b3}#miModalReserva button[type=submit]:disabled{background-color:#6c757d;cursor:not-allowed}#miModalReserva .mensaje-inferior{font-size:.85em;margin-top:15px;padding:8px 12px;border-radius:4px;display:none;text-align:center}#miModalReserva .mensaje-inferior.complete{color:#fff;background-color:#454545;border:1px solid #c3e6cb;display:block}#miModalReserva .mensaje-inferior.success{color:#155724;background-color:#d4edda;border:1px solid #c3e6cb;display:block}#miModalReserva .mensaje-inferior.error{color:#721c24;background-color:#f8d7da;border:1px solid #f5c6cb;display:block}#miModalReserva .mensaje-alerta{margin-top:10px;padding:10px;background-color:#e9ecef;border:1px dashed #ccc;border-radius:4px;font-size:.9em;line-height:1.4;text-align:center}#miModalReserva .summary-box-compact{background-color:#f9f9f9;border:1px solid #ddd;border-radius:4px;padding:12px 15px;margin-top:15px}#miModalReserva .summary-box-compact h4{margin-top:0;margin-bottom:10px;font-size:1.1em;color:#333;border-bottom:1px solid #eee;padding-bottom:5px}#miModalReserva .detalle-impuesto-grid{display:grid;grid-template-columns:auto 1fr;gap:6px 15px;font-size:.9em;align-items:center}#miModalReserva .detalle-impuesto-grid strong{font-weight:600}#miModalReserva .detalle-impuesto-grid .text-right{text-align:right}#miModalReserva .detalle-impuesto-grid .grid-divider{grid-column:1/-1;border:0;border-top:1px dashed #eee;margin:8px 0}#miModalReserva .detalle-impuesto-grid .saldo-label{font-weight:700}#miModalReserva .detalle-impuesto-grid .saldo-mxn{font-size:.9em;color:#666;margin-left:5px}#miModalReserva .detalle-impuesto-grid .por-pagar-label{color:#c0392b}#miModalReserva .detalle-impuesto-grid .por-pagar-valor{color:#c0392b;font-weight:700}#miModalReserva .tabla-scroll-container{max-height:200px;overflow-y:auto;margin-top:10px;border:1px solid #ddd;border-radius:4px}#miModalReserva .tabla-pagos-reserva{width:100%;border-collapse:collapse;font-size:.85em;min-width:400px}#miModalReserva .tabla-pagos-reserva td,#miModalReserva .tabla-pagos-reserva th{border:1px solid #eee;padding:7px 10px;text-align:left}#miModalReserva .tabla-pagos-reserva th{background-color:#f5f5f5;font-weight:600;position:sticky;top:0;z-index:1}#miModalReserva .tabla-pagos-reserva tbody tr:nth-child(even){background-color:#fcfcfc}#miModalReserva .monto-group{width:50%;min-width:180px;max-width:250px}@keyframes pulse{0%{opacity:1}50%{opacity:.6}100%{opacity:1}}@keyframes spin{0%{transform:rotate(0)}100%{transform:rotate(360deg)}}#miModalReserva .preview-box{margin-top:10px;padding:10px;background-color:#e9ecef;border:1px dashed #ccc;border-radius:4px;font-size:0.9em;line-height:1.4;min-height:30px;font-weight:600;color:#4a4a4a;}#miModalReserva .mensaje-inferior.loading{color:#0056b3;background-color:#e6f2ff;border:1px solid #b3d9ff;display:flex;align-items:center;justify-content:center;padding-left:40px;min-height:40px;animation:pulse 1.5s infinite ease-in-out}#miModalReserva .mensaje-inferior.loading::before{content:'';position:absolute;left:15px;top:50%;transform:translateY(-50%);width:24px;height:24px;border:4px solid rgba(0,123,255,.3);border-top:4px solid #007bff;border-radius:50%;animation:spin .8s linear infinite}`;

// const modalCSS = `#miModalReserva{position:fixed;z-index:1000;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgba(0,0,0,.5);display:flex;align-items:center;justify-content:center}#miModalReserva .modal-reserva-contenido{background-color:#fefefe;margin:auto;padding:25px;border:1px solid #888;width:90%;max-width:700px;border-radius:8px;position:relative;max-height:90vh;overflow-y:auto;font-family:sans-serif}#miModalReserva .modal-reserva-cerrar{color:#aaa;float:right;font-size:28px;font-weight:700;position:absolute;top:10px;right:20px}#miModalReserva .modal-reserva-cerrar:focus,#miModalReserva .modal-reserva-cerrar:hover{color:#000;text-decoration:none;cursor:pointer}#miModalReserva .reserva-info{font-size:.9em;color:#555;background:#f4f4f4;padding:8px;border-radius:4px;margin-top:-10px}#miModalReserva #formPago,#miModalReserva #formReserva{display:flex;flex-direction:column;gap:15px}#miModalReserva .form-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:15px}#miModalReserva .form-group{display:flex;flex-direction:column}#miModalReserva h5{font-size:1.1em;color:#333;margin-top:20px;margin-bottom:10px;border-bottom:1px solid #eee;padding-bottom:5px}#miModalReserva label{margin-bottom:5px;font-weight:700;font-size:.9em}#miModalReserva input[type=number],#miModalReserva input[type=text],#miModalReserva select{width:100%;padding:10px;height:auto!important;border:1px solid #ccc;border-radius:4px;box-sizing:border-box;background-color:#fff;font-size:1em}#miModalReserva button[type=submit]{background-color:#007bff;color:#fff;padding:10px 15px;border:none;border-radius:4px;cursor:pointer;align-self:flex-end;margin-top:10px}#miModalReserva button[type=submit]:hover{background-color:#0056b3}#miModalReserva #modalReservaMensaje{font-size:.9em;margin-top:15px;padding:10px;border-radius:4px;display:none}#miModalReserva #modalReservaMensaje.success{color:#155724;background-color:#d4edda;border:1px solid #c3e6cb;display:block}#miModalReserva #modalReservaMensaje.error{color:#721c24;background-color:#f8d7da;border:1px solid #f5c6cb;display:block}#miModalReserva #noAplicaImpuestoPreview{margin-top:10px;padding:10px;background-color:#e9ecef;border:1px dashed #ccc;border-radius:4px;font-size:1em;line-height:1.5} #impuestoPreview{margin-top:10px;padding:10px;background-color:#e9ecef;border:1px dashed #ccc;border-radius:4px;font-size:1em;line-height:1.5}#miModalReserva .summary-box{background-color:#f9f9f9;border:1px solid #ddd;border-radius:4px;padding:15px;margin-top:15px}#miModalReserva .summary-box h4{margin-top:0}#miModalReserva .summary-box p{margin:5px 0}#miModalReserva .balance-box .por-pagar-label{font-weight:700}#miModalReserva .balance-box .por-pagar-valor{font-weight:700;color:#c0392b}#miModalReserva .balance-grid,#miModalReserva .balance-grid-sub{display:grid;grid-template-columns:100px 1fr;align-items:center;gap:5px 15px}#miModalReserva .balance-grid-sub{font-size:.9em;color:#666}#miModalReserva .text-right{text-align:right}#miModalReserva .tabla-pagos-reserva{width:100%;border-collapse:collapse;margin-top:10px}#miModalReserva .tabla-pagos-reserva td,#miModalReserva .tabla-pagos-reserva th{border:1px solid #ddd;padding:8px;text-align:left;font-size:.9em}#miModalReserva .tabla-pagos-reserva th{background-color:#f2f2f2}`;
...
/**
     * Muestra un mensaje en el área de notificaciones del modal.
     * @param {string} message - El texto del mensaje.
     * @param {string} type - El tipo de mensaje ('info', 'success', 'error', 'loading', 'complete').
     * @param {boolean} show - Si se debe mostrar u ocultar el mensaje.
     */
    function showMessage(message, type = 'info', show = true) {
        ...
        // **CORRECCIÓN CLAVE**: Limpiar todas las clases de estado antes de agregar la nueva.
        // Esto previene que la clase 'loading' persista cuando se muestra otro tipo de mensaje.
...
function poblarSelect(selectElement, data, valueField, textField, defaultOptionText = 'Seleccione...') {
 ...
 function actualizarMontoPago() {
    ...
    if (isEfectivo && monedaInfo && monedaInfo.value != 'MXN') {
